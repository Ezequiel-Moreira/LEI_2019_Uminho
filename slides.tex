...
\begin{slide}{Fork and Join}
    \begin{itemize}
        \item
            \ensuremath{ \bigtriangledown \mathbin{::}\Conid{Cartesian}\;\Varid{k}\Rightarrow (\Varid{a}\;\text{\ttfamily 'k'}\;\Varid{c})\to (\Varid{a}\;\text{\ttfamily 'k'}\;\Varid{d})\to (\Varid{a}\;\text{\ttfamily 'k'}\;(\Varid{c}\mathbin{×}\Varid{d}))}
        \item
            \ensuremath{ \bigtriangleup \mathbin{::}\Conid{Cartesian}\;\Varid{k}\Rightarrow (\Varid{c}\;\text{\ttfamily 'k'}\;\Varid{a})\to (\Varid{d}\;\text{\ttfamily 'k'}\;\Varid{a})\to ((\Varid{c}\mathbin{+}\Varid{d})\;\text{\ttfamily 'k'}\;\Varid{a})}
    \end{itemize}
\end{slide}
