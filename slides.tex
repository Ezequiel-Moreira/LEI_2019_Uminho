...
\ensuremath{\Varid{sqr}\mathrel{=}\Varid{mulC}\; \circ \;(\Varid{id}\; \Delta \;\Varid{id})}\\
\ensuremath{\Varid{magSqr}\mathrel{=}\Varid{addC}\; \circ \;(\Varid{mulC}\; \circ \;(\Varid{exl}\; \Delta \;\Varid{exl})\; \Delta \;\Varid{mulC}\; \circ \;(\Varid{exr}\; \Delta \;\Varid{exr}))}\\
\ensuremath{\Varid{cosSinProd}\mathrel{=}(\Varid{cosC}\; \Delta \;\Varid{sinC})\; \circ \;\Varid{mulC}}\\
\end{block} 
\end{frame}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Conf}\;\Varid{f}\;\Varid{x}\;\Conid{Cont}\;\Varid{g}\mathrel{=}\Conid{Cont}\;( \nabla \mathbin{\circ}(\Varid{f}\;\Varid{x}\;\Varid{g})\mathbin{\circ}\Varid{unjoin}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Cartesian}\;\Varid{k}\Rightarrow\Conid{Cartesian}\;\Conid{Cont}\;(\Varid{k},\Varid{r})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{exl}\mathrel{=}\Conid{Cont}\;( \nabla \mathbin{\circ}\Varid{inl});\Varid{exr}\mathrel{=}\Conid{Cont}\;( \nabla \mathbin{\circ}\Varid{inr}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{jam}\mathrel{=}\Conid{Cont}\;( \nabla \mathbin{\circ}\Varid{dup}){}\<[E]%
\\[\blanklineskip]%
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{class}\;\Conid{HasDot}\;(\Conid{S})\;\Varid{u}\;\mathbf{where}\;\Varid{dot}\mathbin{::}\Varid{u}\rightarrow (\Varid{u}\mathbin{-} \circ \;\Varid{s}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}((\Varid{b}\mathbin{-} \circ \;\Varid{s})\rightarrow (\Varid{a}\mathbin{-} \circ \;\Varid{s}))\rightarrow (\Varid{b}\mathbin{-} \circ \;\Varid{a}){}\<[E]%
\\
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{crossI}\;\Varid{fs}\mathrel{=}\Conid{D}\;((\Varid{id} \times \Varid{crossI})\; \circ \;\Varid{unzip}\; \circ \;\Varid{crossI}\;(\Varid{fmap}\;\Varid{unD}\;\Varid{fs})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{exl}\mathrel{=}\Varid{linearD}\;\Varid{exl}\;\Varid{exl}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
