...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[10]{}\mathcal{D}^{2}\mathrel{=}\mathcal{D}\mathbin{\circ}\mathcal{D}\mathbin{::}(\Varid{a}\rightarrow \Varid{b})\rightarrow (\Varid{a}\rightarrow (\Varid{a}\;\multimap \;\Varid{a}\;\multimap \;\Varid{b})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\end{defi}
\end{frame}
