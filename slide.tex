...
\begin{slide}{Fork and Join}
    \begin{itemize}
        \item
            \ensuremath{ \Delta \mathbin{::}\Conid{Cartesian}\;\Varid{k}\Rightarrow (\Varid{a}\;\text{\tt 'k'}\;\Varid{c})\to (\Varid{a}\;\text{\tt 'k'}\;\Varid{d})\to (\Varid{a}\;\text{\tt 'k'}\;(\Varid{c}\mathbin{×}\Varid{d}))}
        \item
            \ensuremath{ \nabla \mathbin{::}\Conid{Cartesian}\;\Varid{k}\Rightarrow (\Varid{c}\;\text{\tt 'k'}\;\Varid{a})\to (\Varid{d}\;\text{\tt 'k'}\;\Varid{a})\to ((\Varid{c}\mathbin{+}\Varid{d})\;\text{\tt 'k'}\;\Varid{a})}
    \end{itemize}
\end{slide}
