...
\section{Implementation}
	...
	From its study our group learned a lot about the topics in the article as well as developed an initial version of the algorithm proposed above, giving us insight into a new way of developing and implementing programs.
	...
	\section{Future Work}
    \paragraph{}
	As we have noted before, we have created an implementation of the algorithm expressed in the article.
	However, what we have implemented is a less efficient version of the algorithm described in the article.
